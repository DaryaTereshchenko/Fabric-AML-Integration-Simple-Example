    ...
    with mlflow.start_run(run_name="cicd-train") as run:
        ...
        if workspace_id:
            try:
                ...
                experiment_name = "superstore-forecast-cicd"
                try:
                ...
                print(f"  WARNING: Fabric MLflow registration failed (non-blocking): {e}")
                print("  Ensure the service principal has Contributor access to the Fabric workspace.")
